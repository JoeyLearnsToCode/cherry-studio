...
export function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.File_SaveBase64Image, (e, data, prompt) => fileManager.saveBase64Image(e, data, prompt))
  ...
  ipcMain.handle(IpcChannel.File_Download, (e, url, isUseContentType, prompt) =>
    fileManager.downloadFile(e, url, isUseContentType, prompt)
  )
  ipcMain.handle(IpcChannel.File_DownloadImage, (e, url, prompt) => fileManager.downloadImageToLocal(e, url, prompt))
  ipcMain.handle(IpcChannel.File_SaveBase64ImageLocal, (e, data, prompt) =>
    fileManager.saveBase64ImageToLocal(e, data, prompt)
  )
