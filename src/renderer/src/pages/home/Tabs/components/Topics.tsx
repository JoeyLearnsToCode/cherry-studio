            ...
            onClick: async () => {
              ...
              if (isPending(topic.id)) {
                for (let i = messages.length - 1; i >= 0; i--) {
                  ...
                  const isComplete = msg.role === 'user' || (msg.role === 'assistant' && msg.status === 'success')
                  if (isComplete) {
              ...
              const success = await store.dispatch(cloneMessagesToNewTopicThunk(topic.id, branchPointIndex, newTopic))
